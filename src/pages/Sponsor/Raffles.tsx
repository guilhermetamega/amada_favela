...
export default function SponsorRafflesPage() {
  ...
  useEffect(() => {
    ...
    if (state === "success") setSuccessMessage("Conta Mercado Pago conectada com sucesso.");
    if (state === "error") setErrorMessage(message || "Falha ao conectar Mercado Pago.");
  ...
  async function connectMercadoPago() {
    ...
    try {
      ...
      setErrorMessage(error instanceof Error ? error.message : "Erro ao conectar Mercado Pago.");
    } finally {

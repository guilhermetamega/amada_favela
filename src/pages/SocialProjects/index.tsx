                ...
                >
                  ...
                  >
                    <div className="relative">
                      <div className="aspect-square w-full overflow-hidden bg-zinc-100 dark:bg-zinc-800">
                        {item.pic_1_url ? (
                          ...
                          <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-emerald-100 via-sky-100 to-pink-100 text-zinc-500 dark:from-emerald-500/15 dark:via-sky-500/10 dark:to-pink-500/15 dark:text-zinc-300">
                            <HeartHandshake className="h-8 w-8" />
                          </div>
                        )}
                      </div>

                      <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent px-3 pb-3 pt-12">
                        <div className="flex items-end justify-between gap-2">
                          <span className="inline-flex items-center rounded-full border border-white/15 bg-white/15 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-white backdrop-blur">
                    ...
                    <div className="space-y-3 p-3 sm:p-4">
                      <h2 className="line-clamp-2 min-h-[2.8rem] text-sm font-black leading-5 text-zinc-900 dark:text-white sm:text-base">
                        {item.title}
                      </h2>

                      <div className="grid gap-2">
                        <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-2.5 dark:border-emerald-500/20 dark:bg-emerald-500/10">
                          <div className="flex items-start gap-2">
                            <span className="mt-0.5 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-xl bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300">
                              <MapPin className="h-4 w-4" />
                            </span>

                            <div className="min-w-0">
                              <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-emerald-700/80 dark:text-emerald-200/80">
                                Comunidade
                              </p>
                              <p className="mt-1 line-clamp-2 text-xs font-semibold text-zinc-900 dark:text-white sm:text-sm">
                                {item.community}
                              </p>
                            </div>
                          </div>
                      ...
                      <p className="line-clamp-3 text-xs leading-5 text-zinc-600 dark:text-zinc-300 sm:text-sm">
                        {item.description}
                      </p>

                      <div className="pt-1">
                        <span className="inline-flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-emerald-500 to-green-500 px-3 py-2.5 text-xs font-semibold text-white shadow-md transition group-hover:opacity-95 sm:text-sm">
                          Ver detalhes

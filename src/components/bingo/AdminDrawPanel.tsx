...
import BingoNumberTrail from "@/components/bingo/NumberTrails";
    ...
    <section className="space-y-4">
      ...
      <div className="overflow-hidden rounded-4xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="flex flex-col items-center gap-5 p-5 sm:p-8">
          <div className="relative flex aspect-square w-48 items-center justify-center rounded-full bg-linear-to-br from-amber-200 via-amber-400 to-orange-500 p-3 shadow-2xl shadow-amber-500/20 sm:w-64">

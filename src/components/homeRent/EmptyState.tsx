...
export default function HomeRentEmptyState({ canCreate, onCreate }: Props) {
  return (
    <section className="rounded-3xl border border-dashed border-zinc-300 bg-white px-6 py-12 text-center dark:border-zinc-700 dark:bg-zinc-900">
      ...
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        Ajuste os filtros ou publique um novo anúncio para começar.
      </p>
      ...
      >
        {canCreate ? "Criar novo item" : "Quero anunciar"}
      </button>
    </section>
  );
}

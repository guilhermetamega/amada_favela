...
export default function LostAnimalsHero({ total }: Props) {
  return (
    <section className="overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      <div className="bg-linear-to-r from-amber-500/10 via-sky-500/10 to-emerald-500/10 px-5 py-5 dark:from-amber-500/15 dark:via-sky-500/10 dark:to-emerald-500/10 sm:px-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h2 className="mt-3 text-xl font-bold tracking-tight text-zinc-900 dark:text-white sm:text-2xl">
              Animais na sua comunidade
            </h2>

            <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
              Consulte animais perdidos e encontrados publicados na sua região.
            </p>
          </div>

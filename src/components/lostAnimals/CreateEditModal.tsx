...
import { createLostAnimalsItem } from "@/services/supabase/lost_animals";
import type { LostAnimalsItem } from "@/types/lost_animals";

type Props = {
  open: boolean;
  onClose: () => void;
  onSaved: (item: LostAnimalsItem) => void;
  communityName: string;
  initialItem?: LostAnimalsItem | null;
};
...
export default function LostAnimalsCreateEditModal({
  open,
  onClose,
  onSaved,
  communityName,
  ...
  const formId = "lost-animals-create-edit-form";
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const created = await createLostAnimalsItem({
        name: form.name.trim(),

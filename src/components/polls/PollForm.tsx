    ...
    <div className="flex min-h-full flex-col">
      <div className="flex-1 space-y-5 p-5">
        ...
        <div className="space-y-3">
          ...
          <div className="max-h-[32dvh] space-y-3 overflow-y-auto pr-1 scrollbar-hide sm:max-h-[36dvh]">
      ...
      <div className="sticky bottom-0 border-t border-zinc-200 bg-white px-5 py-4 dark:border-zinc-800 dark:bg-zinc-900">
